...
One of the festest and simplest ways to grant OpenShift access to many users is to add a GitHub Identity provider to your OpenShift Cluster.
...
* console.redhat.com
* configure new Identity provider (GitHub)
* provide client details from new registed OAuth application
* ...
