...
Therefore, it's important to have at least one Authentication Provider configured.

The steps below will walk you through 2 fairly simple Authentication Providers to get you started.
