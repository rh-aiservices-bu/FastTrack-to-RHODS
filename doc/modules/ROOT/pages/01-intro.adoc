...
* Should you find inaccuracies in this content, please open an Issue in the link:https://github.com/rh-aiservices-bu/FastTrack-to-RHODS[github project] in order to bring it to my attention.

=== Freshness

It is possible that this document falls behind as things evolve.

If unsure, check the history of the page in the link:https://github.com/rh-aiservices-bu/FastTrack-to-RHODS[github project] to see when it was last updated.
