...
* An illustrated and opinionated HowTo on setting up RedHat OpenShift Data Science (RHODS) environments
...
* Troy, for his participation and the fresh eyes he brought to this project
