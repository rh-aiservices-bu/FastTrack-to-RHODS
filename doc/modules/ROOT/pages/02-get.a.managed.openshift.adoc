...
* Decide if you want to use the 60-day xref:#OSDTrial[OSD Trial]
--
====

[#cluster-requirements]
== Managed OpenShift Cluster Requirements for RHODS

* It has to be a **Managed** OpenShift:
** either RedHat OpenShift Service on AWS (ROSA) or OpenShift Dedicated (OSD)
** not a general OpenShift Container Platform (OCP) cluster
* It has to be on **AWS**
